...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field 'numero_usuarios', :label => 'Usuarios logged in'
    config.add_index_field 'memoria_en_uso', :label => 'Memoria en uso'
    ...
    config.add_show_field 'numero_usuarios', :label => 'Usuarios logged in'
    config.add_show_field 'memoria_en_uso', :label => 'Memoria en uso'
